...
void adc_init(){
	...
	ADCSRA_reg	|= (1<<ADEN_bit) | (1<<ADIE_bit) | (1<<ADIE_bit) | (1<<ADPS2_bit) | (1<<ADPS1_bit);
	...
	ADCSRB_reg	&= ~((1<<ACME_bit) | (1<<MUX5_bit) | (1<<ADTS1_bit) | (1<<ADTS2_bit) | (1<<ADTS0_bit))  ;
	...
	ADMUX_reg &= ~((1<<MUX0_bit) | (1<<MUX1_bit) | (1<<MUX2_bit) | (1<<MUX3_bit) | (1<<MUX4_bit) | (1<<REFS1_bit));
