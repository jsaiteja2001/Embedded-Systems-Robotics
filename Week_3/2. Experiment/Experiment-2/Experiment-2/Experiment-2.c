...
void timer_pwm_init(void) {
	...
	TCCR5A_reg = TCCR5A_reg| ((1<<COMA1_bit)  | (1<<COMB1_bit) | (1<<WGM0_bit));
	TCCR5A_reg = TCCR5A_reg& (~((1<<COMA0_bit) | (1<<COMB0_bit) | (1<<WGM1_bit) | (1<<WGM3_bit) | (1<<WGM2_bit)));
	
	
	// Configure for Phase Correct PWM
	// Set Pre-scalar to 64
	TCCR5B_reg = TCCR5B_reg| ((1<<CS0_bit) | (1<<CS1_bit) | (1<WGM2_bit)) ;
	TCCR5B_reg = TCCR5B_reg& (~((1<<CS2_bit) | (1<<WGM3_bit)));
