...
{
	wl_sensors_ddr_reg    &= ~((1<<right_wl_sensor_pin) | (1<<center_wl_sensor_pin) | (1<<left_wl_sensor_pin));

// Deactivate pull-up for ONLY for three white line sensor pins
wl_sensors_port_reg    &= ~((1<<right_wl_sensor_pin) | (1<<center_wl_sensor_pin) | (1<<left_wl_sensor_pin));
}
...
void adc_init()
{
	ADCSRA_reg  = (ADCSRA_reg | ((1<<ADEN_bit) | (1<<ADPS2_bit) | (1<<ADPS1_bit))) & ~((1<<ADSC_bit) | (1<<ADATE_bit) | (1<<ADIF_bit) | (1<<ADIE_bit) | (1<ADPS0_bit));
...
ADMUX_reg  = (ADMUX_reg | (1<<REFS0_bit)) & ~((1<<REFS1_bit) | (1<<MUX4_bit) | (1<<MUX3_bit) | (1<<MUX2_bit) | (1<<MUX1_bit) | (1<<MUX0_bit)) ;
